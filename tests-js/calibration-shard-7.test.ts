// tests-js/calibration-shard-7.test.ts — seed-42 calibration sweep, shard 7/8.
...
describe(`calibration sweep — seed 42 vs JS baseline v${version} (shard 7/${CALIBRATION_SHARD_COUNT})`, () => {
  registerCalibrationShard(7);
});