// tests-js/calibration-shard-2.test.ts — seed-42 calibration sweep, shard 2/8.
...
describe(`calibration sweep — seed 42 vs JS baseline v${version} (shard 2/${CALIBRATION_SHARD_COUNT})`, () => {
  registerCalibrationShard(2);
});