// tests-js/calibration-shard-4.test.ts — seed-42 calibration sweep, shard 4/8.
...
describe(`calibration sweep — seed 42 vs JS baseline v${version} (shard 4/${CALIBRATION_SHARD_COUNT})`, () => {
  registerCalibrationShard(4);
});