// tests-js/calibration-shard-6.test.ts — seed-42 calibration sweep, shard 6/8.
...
describe(`calibration sweep — seed 42 vs JS baseline v${version} (shard 6/${CALIBRATION_SHARD_COUNT})`, () => {
  registerCalibrationShard(6);
});