// tests-js/calibration-shard-1.test.ts — seed-42 calibration sweep, shard 1/8.
...
describe(`calibration sweep — seed 42 vs JS baseline v${version} (shard 1/${CALIBRATION_SHARD_COUNT})`, () => {
  registerCalibrationShard(1);
});