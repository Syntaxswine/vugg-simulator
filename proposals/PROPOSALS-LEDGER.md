...
| 14 | **deccan_zeolite Stage-II narrative gap** | ✅ SHIPPED v200 | The step-70 event narrated *"Stilbite + heulandite + calcite blades"* while neither mineral existed (a positive over-promise — the mvt-silver-deconfab discipline). FIXED: shipped both zeolites (the dehydration couple, Fridriksson 2001) + trued the event text + added both to deccan expects_species (fire 20/20 seeds). baseline-diff: 1/34 moved (deccan only), zero losses; coverage Live 137→139; CI 1931/1931. |
