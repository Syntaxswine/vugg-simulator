...
> **OPEN (final):** §10.5 tranches 2-3 (picker/zen/Begin surfaces need the ~90-string
> menu.group/menu.label data migration — sized, own pass) · UV-palette scale audit (other
> minerals' gates still broth-scale; js/27 predict_fluorescence same disease but feeds narrators →
> SIM-adjacent, instruments-first) · shigar aqua SIZE (should the etch leave 0.13-0.6 mm in
