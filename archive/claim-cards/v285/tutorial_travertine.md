# CLAIM CARD — tutorial_travertine  (v285, seed 42, 60 steps)
...
**Scenario spec hash:** 56b74adf3f7b97571b091539260ec584aa8a230ada6e35e0fd64a369b2ce0450
**Archived strip SHA-256:** b07985da8f2b8d295e31a8dc786d95df8d89425b48aab17f5dc1ddc6bfee73ed
...
**Deterministic accessories (1):** aragonite — A scientifically meaningful CaCO3 polymorph competitor in the travertine tutorial's changing temperature and Mg/Ca conditions.
**Statistical (0):** (none)
**Aspirational (0):** (none)
...
## Environment trajectory (first → last, [min,max])
  - T: 68.26089435471157 → 38.80504261804766 °C  [38.80504261804766, 68.69096292895266] (raw_simulation_state)
  - pH: 6.5 → 8.216823780760844   [6.433403383755234, 8.24971911723565] (raw_simulation_state)
...
## Saturation drivers
  ...
  - SI_aragonite: 0.063 → 1.386  [-0.189, 1.827]
  - SI_dolomite: -0.441 → 2.394  [-0.819, 3.087]
  - SI_HMC: 0.063 → 1.449  [-0.126, 1.827]
  - SI_siderite: 0.693 → 2.016  [0.441, 2.457]
  - SI_selenite: -8 → -1.512  [-8, -1.449]
  - SI_anhydrite: -1.323 → -1.638  [-1.638, -1.323]
  - SI_barite: -8 → -8  [-8, -8]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 68.26089435471157 → 38.80504261804766 °C [38.80504261804766, 68.69096292895266], n=60
  - Secure aragonite assessment: 0/60 executed steps; first={"boundary_kbar":2.7139875197433567,"secure_aragonite":false}, last={"boundary_kbar":2.8914065217737637,"secure_aragonite":false}
  ...
  - Conserved carbonate boundary: 60 samples; mode closed→closed; DIC 0.00833194467588735→0.005077281699922697 mol/kg; export 0.011282968093395275 mol/kg; reduced alkalinity 0.005071923670498168 eq/kg; blocked=false; failed latest transactions=0; uncertainties=["full_alkalinity_systems_omitted"]
...
## Layer, solid-solution, competition, and habit testimony
  - Accepted layers: 108; formula-bearing=0; solid-solution=0; binding competition=0; reactive transformation etches=0; masked horizons=0.
  - Registered-mineral morphology: positive=59; classified=59; unavailable=0; terminal-depleted=1; regimes={"spiral_smooth":34,"stepped_mild":25}; bases={"post-step":58,"post-step-terminal-depleted":1}.
  - Terminal-depleted morphology crystal 1, step 8: calcite; post-step sigma=0.9646941538360475; surface sigma=1.0273952478914206; regime=spiral_smooth; form=rhombohedral.
  - Habit crystal 1: calcite; travertine_crust; extent=individual; forms=["laminated microcrystalline calcite terrace crust","flow-normal surface coating"]; size authority={"extent_kind":"individual","cap_cm":2000,"record_cm":1000}; CDR=null.
