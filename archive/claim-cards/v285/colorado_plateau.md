# CLAIM CARD — colorado_plateau  (v285, seed 42, 180 steps)
...
**Scenario spec hash:** 621a82b560e92c8c2f11f1bd76963d1a236514a89c79d200084fb348d1faa200
**Archived strip SHA-256:** b01ed2673fc2587f556bddd7f93feb10cc92e53ba0a65ec02938790e8e98b78c
...
**Deterministic headline (2):** carnotite, tyuyamunite
**Deterministic accessories (2):** opal — Low-temperature hydrated silica is a plausible sandstone pore cement at the oxidizing roll front.; uranophane — A common secondary uranyl silicate in oxidized sandstone uranium systems; accessory to the diagnostic uranyl vanadates.
**Statistical (0):** (none)
**Aspirational (0):** (none)
...
## Environment trajectory (first → last, [min,max])
  - T: 22 → 20 °C  [18, 22] (raw_simulation_state)
  ...
  - O2: 1.2 → 1 ppm (mg/kg solvent)  [1, 1.5] (raw_simulation_state)
  - concentration: 1 → 1 ×  [1, 1] (raw_simulation_state)

## Saturation drivers
  - SI_calcite: -1.008 → -1.071  [-1.512, -1.008]
  - SI_aragonite: -1.134 → -1.197  [-1.638, -1.134]
  - SI_dolomite: -2.52 → -2.646  [-2.961, -2.52]
  - SI_HMC: -1.071 → -1.134  [-1.512, -1.071]
  - SI_siderite: 0.126 → 0.252  [0.126, 0.378]
  - SI_selenite: -2.394 → -2.394  [-2.898, -2.394]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 22 → 20 °C [18, 22], n=180
  - Secure aragonite assessment: 0/180 executed steps; first={"boundary_kbar":3.0112849400000004,"secure_aragonite":false}, last={"boundary_kbar":3.0264545399999996,"secure_aragonite":false}
...
## Layer, solid-solution, competition, and habit testimony
  - Accepted layers: 2193; formula-bearing=0; solid-solution=0; binding competition=1; reactive transformation etches=0; masked horizons=0.
  - Registered-mineral morphology: positive=0; classified=0; unavailable=0; terminal-depleted=0; regimes={}; bases={}.
  - Competition crystal 6, step 20: uranophane; {"schema":"graduated-competition-residual-v1","crystal_id":6,"scaling":0.9880938035106355,"limiting_species":"U","requested_per_species":{"Ca":0.5553529184111623,"U":6.59634007831382,"SiO2":1.664950266374383},"allocated_per_species":{"Ca":0.5487407774436169,"U":6.517802757230745,"SiO2":1.6451270413579098},"allocation_rounds":1}.
  - Habit crystal 1: tyuyamunite; tabular_plates; extent=individual; forms=["diamond-shaped {001} plates","tabular crystals"]; size authority={"extent_kind":"individual","cap_cm":1,"record_cm":0.5}; CDR=null.
  - Habit crystal 2: uranophane; acicular_starburst; extent=individual; forms=["radiating needles 0.1-5 mm","star-shaped clusters in vugs"]; size authority={"extent_kind":"individual","cap_cm":5,"record_cm":2.5}; CDR=null.
  - Habit crystal 3: opal; nodular; extent=individual; forms=["nodular massive","glassy conchoidal fracture"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 4: uranophane; acicular_starburst; extent=individual; forms=["radiating needles 0.1-5 mm","star-shaped clusters in vugs"]; size authority={"extent_kind":"individual","cap_cm":5,"record_cm":2.5}; CDR=null.
  - Habit crystal 5: opal; nodular; extent=individual; forms=["nodular massive","glassy conchoidal fracture"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 6: uranophane; acicular_starburst; extent=individual; forms=["radiating needles 0.1-5 mm","star-shaped clusters in vugs"]; size authority={"extent_kind":"individual","cap_cm":5,"record_cm":2.5}; CDR=null.
  - Habit crystal 7: opal; nodular; extent=individual; forms=["nodular massive","glassy conchoidal fracture"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 8: tyuyamunite; tabular_plates; extent=individual; forms=["diamond-shaped {001} plates","tabular crystals"]; size authority={"extent_kind":"individual","cap_cm":1,"record_cm":0.5}; CDR=null.
  - Habit crystal 9: opal; nodular; extent=individual; forms=["nodular massive","glassy conchoidal fracture"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 10: opal; nodular; extent=individual; forms=["nodular massive","glassy conchoidal fracture"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 11: tyuyamunite; tabular_plates; extent=individual; forms=["diamond-shaped {001} plates","tabular crystals"]; size authority={"extent_kind":"individual","cap_cm":1,"record_cm":0.5}; CDR=null.
  - Habit crystal 12: tyuyamunite; tabular_plates; extent=individual; forms=["diamond-shaped {001} plates","tabular crystals"]; size authority={"extent_kind":"individual","cap_cm":1,"record_cm":0.5}; CDR=null.
  - Habit crystal 13: tyuyamunite; tabular_plates; extent=individual; forms=["diamond-shaped {001} plates","tabular crystals"]; size authority={"extent_kind":"individual","cap_cm":1,"record_cm":0.5}; CDR=null.
  - Habit crystal 14: carnotite; tabular_plates; extent=individual; forms=["diamond-shaped {001} plates","tabular crystals"]; size authority={"extent_kind":"individual","cap_cm":1,"record_cm":0.5}; CDR=null.
  - Habit crystal 15: carnotite; tabular_plates; extent=individual; forms=["diamond-shaped {001} plates","tabular crystals"]; size authority={"extent_kind":"individual","cap_cm":1,"record_cm":0.5}; CDR=null.
  - Habit crystal 16: carnotite; tabular_plates; extent=individual; forms=["diamond-shaped {001} plates","tabular crystals"]; size authority={"extent_kind":"individual","cap_cm":1,"record_cm":0.5}; CDR=null.
  - Habit crystal 17: carnotite; tabular_plates; extent=individual; forms=["diamond-shaped {001} plates","tabular crystals"]; size authority={"extent_kind":"individual","cap_cm":1,"record_cm":0.5}; CDR=null.
