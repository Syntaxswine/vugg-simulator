# CLAIM CARD — stalactite_demo  (v285, seed 42, 100 steps)
...
**Archived strip SHA-256:** 7e8730cc803305cc73c6649f2f9dc7787a1b71b65b19330f858769c6a9c91c95
...
## Layer, solid-solution, competition, and habit testimony
  - Accepted layers: 110; formula-bearing=0; solid-solution=0; binding competition=0; reactive transformation etches=0; masked horizons=0.
  - Registered-mineral morphology: positive=110; classified=110; unavailable=0; terminal-depleted=0; regimes={"hopper_skeletal":22,"stepped_macro":88}; bases={"post-step":110}.
  - Habit crystal 1: calcite; stepped_rhombohedral; extent=individual; forms=["e{104} rhombohedron with macrostep terraces","pagoda-stacked faces"]; size authority={"extent_kind":"individual","cap_cm":2000,"record_cm":1000}; CDR=null.
