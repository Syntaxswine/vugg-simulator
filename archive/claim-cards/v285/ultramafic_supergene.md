# CLAIM CARD — ultramafic_supergene  (v285, seed 42, 200 steps)
...
**Scenario spec hash:** 55438e3705b2bd2f55a2529fbd204c0122792305b5ab709ea3bae062413cdd80
**Archived strip SHA-256:** 9f569505fbc7ad1faa2e552d8f0c18e4d5a9ee13173f9e1a616d912513564a93
...
**Deterministic headline (2):** chrysoprase, calcite
**Deterministic accessories (2):** dolomite — A plausible Mg-rich carbonate accessory in the ultramafic saprolite fracture system.; opal — Hydrated silica is a plausible competitor during low-temperature Ni-silica precipitation.
**Statistical (0):** (none)
**Aspirational (2):** quartz — The authored silica inventory is intentionally sufficient for chalcedony-family chrysoprase but does not guarantee macroscopic quartz nucleation.; goethite — A characteristic Fe-weathering product remains locality-licensed in the oxidized laterite profile, but is absent from all three SIM 272 commissioned seeds.
...
**Aspirational no-shows (non-failing):** quartz, goethite
**Excluded-locality appearances (failing):** (none)

## Environment trajectory (first → last, [min,max])
  - T: 28.26089435471214 → 24.999999999999847 °C  [24.999999999999847, 28.26089435471214] (raw_simulation_state)
  - pH: 8.5 → 10   [8.5, 10] (raw_simulation_state)
...
## Saturation drivers
  - SI_calcite: 0 → 1.26  [-0.063, 1.26]
  - SI_aragonite: -0.126 → 1.134  [-0.189, 1.134]
  - SI_dolomite: 1.386 → 3.969  [1.26, 3.969]
  - SI_HMC: 0.126 → 1.386  [0.063, 1.386]
  - SI_siderite: 2.016 → 3.213  [1.953, 3.213]
  - SI_selenite: -3.15 → -3.15  [-3.213, -3.15]
  - SI_anhydrite: -3.402 → -3.465  [-3.465, -3.402]
  - SI_barite: -8 → -8  [-8, -8]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 28.26089435471214 → 24.999999999999847 °C [24.999999999999847, 28.26089435471214], n=200
  - Secure aragonite assessment: 0/200 executed steps; first={"boundary_kbar":2.965038602582306,"secure_aragonite":false}, last={"boundary_kbar":2.9888905400000016,"secure_aragonite":false}
...
**Source:** accepted host-over-guest and later liberation events from the archived executed run
  - Step 177: opal #6 enclosed calcite #18; route=geometric-overlap; host net layer=13.207464413473675 µm; distance/reach=8.196896210329466/13.724254340334914 mm; size ratio=7794.945356842867; guest recent=0.26208807685905994 µm; guest core/loss/remaining=0.26208807685905994/0/0.26208807685905994 µm; partial loss=false.
  - Step 180: opal #2 enclosed calcite #19; route=geometric-overlap; host net layer=15.628594458582983 µm; distance/reach=6.444180362150648/16.654312207712813 mm; size ratio=8123.597723690113; guest recent=0.27012444286605064 µm; guest core/loss/remaining=0.27012444286605064/0/0.27012444286605064 µm; partial loss=false.
  - Step 183: chrysoprase #14 enclosed calcite #20; route=geometric-overlap; host net layer=34.240465165500055 µm; distance/reach=4.680175946349594/10.634005918640405 mm; size ratio=4778.983118649885; guest recent=0.27224381829298 µm; guest core/loss/remaining=0.27224381829298/0/0.27224381829298 µm; partial loss=false.
...
## Layer, solid-solution, competition, and habit testimony
  - Accepted layers: 1515; formula-bearing=0; solid-solution=0; binding competition=0; reactive transformation etches=0; masked horizons=0.
  - Registered-mineral morphology: positive=26; classified=26; unavailable=0; terminal-depleted=0; regimes={"stepped_mild":26}; bases={"post-step":26}.
  ...
  - Habit crystal 2: opal; reniform_layer; extent=individual; forms=["reniform layered crusts","concentric banding"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 3: opal; reniform_layer; extent=individual; forms=["reniform layered crusts","concentric banding"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 4: dolomite; coarse_rhomb; extent=individual; forms=["planar rhombohedral {104}","ambient-temperature dolomite"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 5: opal; reniform_layer; extent=individual; forms=["reniform layered crusts","concentric banding"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 6: opal; reniform_layer; extent=individual; forms=["reniform layered crusts","concentric banding"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 7: dolomite; coarse_rhomb; extent=individual; forms=["planar rhombohedral {104}","ambient-temperature dolomite"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 8: opal; reniform_layer; extent=individual; forms=["reniform layered crusts","concentric banding"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 9: dolomite; coarse_rhomb; extent=individual; forms=["planar rhombohedral {104}","ambient-temperature dolomite"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 10: dolomite; coarse_rhomb; extent=individual; forms=["planar rhombohedral {104}","ambient-temperature dolomite"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 11: dolomite; coarse_rhomb; extent=individual; forms=["planar rhombohedral {104}","ambient-temperature dolomite"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 12: dolomite; coarse_rhomb; extent=individual; forms=["planar rhombohedral {104}","ambient-temperature dolomite"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 13: dolomite; coarse_rhomb; extent=individual; forms=["planar rhombohedral {104}","ambient-temperature dolomite"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 14: chrysoprase; nodular_massive; extent=individual; forms=["rounded apple-green nodule in saprolite"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 15: chrysoprase; nodular_massive; extent=individual; forms=["rounded apple-green nodule in saprolite"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 16: chrysoprase; nodular_massive; extent=individual; forms=["rounded apple-green nodule in saprolite"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 17: dolomite; coarse_rhomb; extent=individual; forms=["e{104} saddle-shaped curved rhombohedron","white to colorless"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 18: calcite; stepped_scalenohedral; extent=individual; forms=["v{211} scalenohedron, gentle growth steps","dog-tooth"]; size authority={"extent_kind":"individual","cap_cm":2000,"record_cm":1000}; CDR=null.
  - Habit crystal 19: calcite; stepped_scalenohedral; extent=individual; forms=["v{211} scalenohedron, gentle growth steps","dog-tooth"]; size authority={"extent_kind":"individual","cap_cm":2000,"record_cm":1000}; CDR=null.
  ...
  - Habit crystal 21: calcite; stepped_scalenohedral; extent=individual; forms=["v{211} scalenohedron, gentle growth steps","dog-tooth"]; size authority={"extent_kind":"individual","cap_cm":2000,"record_cm":1000}; CDR=null.
