# CLAIM CARD — chiastolite_hornfels  (v285, seed 42, 120 steps)
...
**Scenario spec hash:** edafb7d2c372878e3975c26b64f0a4d0ddd9e1467ba53ad4ceea83de3337c842
**Archived strip SHA-256:** a76dc3e94c0d277d2cf635baf7e286499b71cf68f4aa3bf0832abfb740ac7301
...
**Deterministic headline (2):** andalusite, feldspar
**Deterministic accessories (1):** albite — Sodic plagioclase is a plausible subordinate phase in the graphitic contact-metamorphic hornfels assemblage; it is not the chiastolite-defining product.
**Statistical (0):** (none)
**Aspirational (0):** (none)
...
## Environment trajectory (first → last, [min,max])
  - T: 598.2608943547123 → 421.0706241640676 °C  [421.0706241640676, 598.2608943547123] (raw_simulation_state)
...
## Saturation drivers
  - SI_calcite: -5.858 → -5.858  [-5.858, -5.858]
  - SI_aragonite: -5.921 → -5.921  [-5.921, -5.921]
  - SI_dolomite: -8 → -8  [-8, -8]
  - SI_HMC: -3.717 → -3.78  [-3.78, -3.717]
  - SI_siderite: -3.087 → -3.087  [-3.087, -3.087]
  - SI_selenite: -8 → -8  [-8, -8]
...
## Authored pressure/stress/phase context (claim, not run testimony)
  ...
  - Ksp pressure rule: reaction-specific SUPCRTBL delta-logK grid; bilinear only inside density and per-reaction temperature masks; no constant reaction-volume proxy
    - calcite: temperature-clamped-to-envelope; active=true; ΔlogK=1.89119161; Requested 600 C is outside this reaction's 10-90 C fitted envelope; the nearest 90 C SUPCRTBL pressure correction is held constant for a continuous, non-extrapolated boundary.
    - aragonite: temperature-clamped-to-envelope; active=true; ΔlogK=1.7952930399999998; Requested 600 C is outside this reaction's 10-90 C fitted envelope; the nearest 90 C SUPCRTBL pressure correction is held constant for a continuous, non-extrapolated boundary.
    - dolomite: temperature-clamped-to-envelope; active=true; ΔlogK=4.8223638300000005; Requested 600 C is outside this reaction's 10-250 C fitted envelope; the nearest 250 C SUPCRTBL pressure correction is held constant for a continuous, non-extrapolated boundary.
    - siderite: temperature-clamped-to-envelope; active=true; ΔlogK=2.02035285; Requested 600 C is outside this reaction's 10-200 C fitted envelope; the nearest 200 C SUPCRTBL pressure correction is held constant for a continuous, non-extrapolated boundary.
    - rhodochrosite: temperature-clamped-to-envelope; active=true; ΔlogK=1.92748259; Requested 600 C is outside this reaction's 10-200 C fitted envelope; the nearest 200 C SUPCRTBL pressure correction is held constant for a continuous, non-extrapolated boundary.
    - anhydrite: temperature-clamped-to-envelope; active=true; ΔlogK=2.885789535; Requested 600 C is outside this reaction's 10-300 C fitted envelope; the nearest 300 C SUPCRTBL pressure correction is held constant for a continuous, non-extrapolated boundary.
    - barite: temperature-clamped-to-envelope; active=true; ΔlogK=2.7174384849999997; Requested 600 C is outside this reaction's 10-300 C fitted envelope; the nearest 300 C SUPCRTBL pressure correction is held constant for a continuous, non-extrapolated boundary.
    - celestine: temperature-clamped-to-envelope; active=true; ΔlogK=1.587219025; Requested 600 C is outside this reaction's 10-200 C fitted envelope; the nearest 200 C SUPCRTBL pressure correction is held constant for a continuous, non-extrapolated boundary.
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 598.2608943547123 → 421.0706241640676 °C [421.0706241640676, 598.2608943547123], n=120
  - Secure aragonite assessment: 0/120 executed steps; first={"boundary_kbar":6.637960672127232,"secure_aragonite":false}, last={"boundary_kbar":3.82574617349702,"secure_aragonite":false}
...
## Layer, solid-solution, competition, and habit testimony
  - Accepted layers: 695; formula-bearing=0; solid-solution=0; binding competition=0; reactive transformation etches=0; masked horizons=0.
  ...
  - Habit crystal 3: andalusite; chiastolite_prism; extent=individual; forms=["m{110} square prism","graphite cross sectors","c{001} basal"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 4: andalusite; chiastolite_prism; extent=individual; forms=["m{110} square prism","graphite cross sectors","c{001} basal"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 5: andalusite; chiastolite_prism; extent=individual; forms=["m{110} square prism","graphite cross sectors","c{001} basal"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 6: andalusite; chiastolite_prism; extent=individual; forms=["m{110} square prism","graphite cross sectors","c{001} basal"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
  - Habit crystal 7: andalusite; chiastolite_prism; extent=individual; forms=["m{110} square prism","graphite cross sectors","c{001} basal"]; size authority={"extent_kind":"individual","cap_cm":30,"record_cm":15}; CDR=null.
